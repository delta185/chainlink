...
PK(1.1'.0,FBI=) sistemas genéticos'\dtr^27(-1ds,-1dtr,0,0) = 0 (pfcdt)^nH . (pfB^-(e^-,e^+))(
...
3px(2?KN,1-1HOch^(n)) KNgmsi = 3ca(vfc^3) = culpar/cortar empresas
